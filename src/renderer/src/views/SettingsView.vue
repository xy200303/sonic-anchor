...
onMounted(async () => {
  ...
  form.value = {
    ...
    commentAppSecret: c.comment.appSecret,
    commentRoomId: c.comment.roomId,
  ...
  try {
    await configStore.save({
      ...
      comment: {
        ...
        appSecret: form.value.commentAppSecret,
        roomId: form.value.commentRoomId,
  ...
  <div class="settings">
    ...
    <n-tabs type="line" class="tabs">
      ...
      <n-tab-pane name="comment" tab="评论监控">
        <n-card class="card">
          <n-form label-placement="top">
            <n-form-item label="抖音开放平台 AppId">
              <n-input v-model:value="form.commentAppId" />
            </n-form-item>
            <n-form-item label="App Secret">
              <n-input v-model:value="form.commentAppSecret" type="password" show-password-on="click" />
            </n-form-item>
            <n-form-item label="直播间房间号">
              <n-input v-model:value="form.commentRoomId" />
            </n-form-item>
